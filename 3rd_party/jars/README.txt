...
https://github.com/bobbylight/SpellChecker
    ...
    https://github.com/bobbylight/SpellChecker/blob/master/LICENSE.md
https://repo1.maven.org/maven2/com/fifesoft/spellchecker/3.4.0/spellchecker-3.4.0.jar

RSTAUI
https://github.com/bobbylight/RSTAUI
    Licensed under the Modified BSD License (BSD 3-Clause "New" or "Revised" License).
    https://github.com/bobbylight/RSTAUI/blob/master/RSTAUI/src/main/dist/RSTAUI.License.txt
https://repo1.maven.org/maven2/com/fifesoft/rstaui/3.3.1/rstaui-3.3.1.jar

RSyntaxTextArea
https://github.com/bobbylight/RSyntaxTextArea
    Licensed under the Modified BSD License (BSD 3-Clause "New" or "Revised" License).
    https://github.com/bobbylight/RSyntaxTextArea/blob/master/LICENSE.md
https://repo1.maven.org/maven2/com/fifesoft/rsyntaxtextarea/3.6.0/rsyntaxtextarea-3.6.0.jar

AutoComplete
https://github.com/bobbylight/AutoComplete
    Licensed under the Modified BSD License (BSD 3-Clause "New" or "Revised" License).
    https://github.com/bobbylight/RSyntaxTextArea/blob/master/LICENSE.md
https://repo1.maven.org/maven2/com/fifesoft/autocomplete/3.3.2/autocomplete-3.3.2.jar
...
https://repo1.maven.org/maven2/org/jetbrains/pty4j/pty4j/0.13.11/pty4j-0.13.11.jar
...
https://repo1.maven.org/maven2/org/jetbrains/kotlin/kotlin-stdlib/2.1.21/kotlin-stdlib-2.1.21.jar
