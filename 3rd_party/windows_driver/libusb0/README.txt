...
binary release:
    ...
    '<JxMake_Source_Root>/3rd_party_library_licenses/LICENSE_GPLv3.txt' and
    'LICENSE_LGPLv3.txt' (the release archive's own COPYING_GPL.txt/COPYING_LGPL.txt are
    text-identical to those, aside from an http->https FSF URL change, so they are not duplicated here).
