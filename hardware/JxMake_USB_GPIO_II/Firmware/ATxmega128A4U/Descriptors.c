...
const USB_Descriptor_Device_t PROGMEM DeviceDescriptor =
{
	...
	// ##### ??? TODO : Use VID & PID from 'https://github.com/obdev/v-usb/blob/master/usbdrv/USB-IDs-for-free.txt' ??? #####
	.VendorID               = 0x03EB,
	.ProductID              = 0x204E,
 ...
 *  Descriptor.
 */
const USB_Descriptor_String_t PROGMEM ManufacturerString = USB_STRING_DESCRIPTOR(L"JxMake (https://sourceforge.net/projects/jxmake)");

/** Product descriptor string. This is a Unicode string containing the product's details in human readable form,
 *  and is read out upon request by the host when the appropriate string ID is requested, listed in the Device
 *  Descriptor.
 */
const USB_Descriptor_String_t PROGMEM ProductString = USB_STRING_DESCRIPTOR(L"JxMake USB-GPIO Module II");
