...
static const uint8_t PROTOCOL_VERSION_M = 2;
static const uint8_t PROTOCOL_VERSION_N = 0;
static const uint8_t PROTOCOL_VERSION_R = 1;

// Firmware version number
static const uint8_t FIRMWARE_VERSION_M = 1;
static const uint8_t FIRMWARE_VERSION_N = 0;
static const uint8_t FIRMWARE_VERSION_R = 5;
...
static const uint8_t         CMD_HW_GPIO_GET_VREAD           = 0x25;
static const uint8_t         CMD_HW_GPIO_CALIBRATE_VREAD     = 0x26;
...
static const _SInt_IZArg_t   HW_SPI_TRANSFER_MAX_SIZE        = PROTOCOL_ARGUMENT_STORE_BUFFER_SIZE;
...
static const uint8_t         CMD_HW_TWI_IS_ENABLED           = 0x69;
static const uint8_t         CMD_HW_TWI_SCAN                 = 0x6A;
static const uint8_t         CMD_HW_TWI_WRITE_ONE_CF         = 0x6C;
static const uint8_t         CMD_HW_TWI_READ_ONE_CF          = 0x6D;
static const _SInt_IZArg_t       HW_TWI_TRANSFER_MAX_SIZE    = PROTOCOL_ARGUMENT_STORE_BUFFER_SIZE;
...
static const _SInt_IZArg_t       BB_USRT_TX_RX_MAX_SIZE      = PROTOCOL_ARGUMENT_STORE_BUFFER_SIZE;
...
static const _SInt_IZArg_t       BB_SWIM_TRANSFER_MAX_SIZE   = PROTOCOL_ARGUMENT_STORE_BUFFER_SIZE;

static const uint8_t         CMD_JTAG_ENABLE                 = 0xF0; // JTAG commands - starts from 0xF0
static const uint8_t         CMD_JTAG_DISABLE                = 0xF1;
static const uint8_t         CMD_JTAG_SET_FREQUENCY          = 0xF2;
static const uint8_t         CMD_JTAG_SET_RESET              = 0xF3;
static const uint8_t         CMD_JTAG_TMS                    = 0xF5;
static const uint8_t         CMD_JTAG_TRANSFER               = 0xF7;
static const uint8_t         CMD_JTAG_XB_TRANSFER            = 0xF8;
static const _SInt_IZArg_t       JTAG_TRANSFER_MAX_SIZE      = PROTOCOL_ARGUMENT_STORE_BUFFER_SIZE;
...
static const int8_t PROGMEM _CMD_PAR_BYTE_LEN[] = {
	...
	/* 0x25 */  0, // CMD_HW_GPIO_GET_VREAD
	/* 0x26 */  2, // CMD_HW_GPIO_CALIBRATE_VREAD
	/* 0x27 */ -1, // <reserved>
	/* 0x28 */ -1, // <reserved>
	/* 0x29 */ -1, // <reserved>
	/* 0x2A */ -1, // <reserved>
	...
	/* 0x67 */ -1, // <reserved>
	/* 0x68 */ -1, // <reserved>
	/* 0x69 */  0, // CMD_HW_TWI_IS_ENABLED
	/* 0x6A */  0, // CMD_HW_TWI_SCAN
	/* 0x6B */ -1, // <reserved>
	/* 0x6C */  5, // CMD_HW_TWI_WRITE_ONE_CF
	/* 0x6D */  4, // CMD_HW_TWI_READ_ONE_CF
	/* 0x6E */ -1, // <reserved>
	/* 0x6F */ -1, // <reserved>
	/* 0x70 */ -1, // <reserved>
	/* 0x71 */ -1, // <reserved>
...
//	/* 0xD3 */  2, // CMD_BB_SWIM_TRANSFER
	...
	/* 0xEE */ -1, // <reserved>
	/* 0xEF */ -1, // <reserved>
	/* 0xF0 */  1, // CMD_JTAG_ENABLE
	/* 0xF1 */  0, // CMD_JTAG_DISABLE
	/* 0xF2 */  1, // CMD_JTAG_SET_FREQUENCY
	/* 0xF3 */  1, // CMD_JTAG_SET_RESET
	/* 0xF4 */ -1, // <reserved>
	/* 0xF5 */  2, // CMD_JTAG_TMS
	/* 0xF6 */ -1, // <reserved>
	/* 0xF7 */  2, // CMD_JTAG_TRANSFER
	/* 0xF8 */  2, // CMD_JTAG_XB_TRANSFER
	/* 0xF9 */ -1, // <reserved>
	/* 0xFA */ -1, // <reserved>
	/* 0xFB */ -1, // <reserved>
	/* 0xFC */ -1, // <reserved>
...
#endif // __PROTOCOL_HANDLER_PRIMARY_C__
