...
public class LoopContinue extends ExecBlock {

    public LoopContinue(final String path, final int lNum, final int cNum)
    ...
    public static LoopContinue loadFromStream(final DataInputStream dis) throws Exception
    {
