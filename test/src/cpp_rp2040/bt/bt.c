 ...
 *
 * The source code in this file is written based on:
 *     https://github.com/raspberrypi/pico-examples/blob/master/pico_w/bt/standalone/server.c
 *     https://github.com/raspberrypi/pico-examples/blob/master/pico_w/bt/standalone/server_common.c
 */
...
int att_write_callback(hci_con_handle_t connection_handle, uint16_t att_handle, uint16_t transaction_mode, uint16_t offset, uint8_t* buffer, uint16_t buffer_size)
{
    ...
    if(le_notification_enabled) att_server_request_can_send_now_event(con_handle);
...
async_at_time_worker_t heartbeat_worker = { .do_work = heartbeat_handler };
