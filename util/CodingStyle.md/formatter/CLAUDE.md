...
| HTML5 deep tree-construction gaps (tc gap job; levels 1-3 landed, level 4 not yet implemented — high risk, read `STATE_HTML5_TCG.md` before attempting) | `STATE_COMMON.md` | `STATE_HTML5_TCG.md` |
