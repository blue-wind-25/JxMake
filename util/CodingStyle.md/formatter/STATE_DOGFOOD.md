...
| Kotlin     | STATE_KOTLIN.md       | JetBrains/kotlin                            | DONE - PARTIAL FIX  | Category 1 (parse errors, C1-C6k) fully closed; Category 2 (idempotency) D2a fixed (328/334), 6 residual + D1/D3/D4 still open, see STATE_KOTLIN.md |
