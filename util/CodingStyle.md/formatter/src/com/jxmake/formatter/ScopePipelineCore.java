...
public abstract class ScopePipelineCore {
    ...
    protected String normalizeLeadingGap(final String leadingGap, final String rawIndent,
     ...
     */
    protected boolean hasTopLevelNewline(final List<Token> tokens, final int fromInclusive, final int toExclusive) {
        int depth = 0;
