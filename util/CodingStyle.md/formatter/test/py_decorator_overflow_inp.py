...
@register(f'Struct331_{signedness}{n}_extra_long_suffix_to_push_this_line_well_past_the_limit', set_name=True)
def make_struct(signedness, n):
    ...

@app.route("/callback", key=lambda ctx: f"{ctx.info_name} default value padding to overflow the limit 1.0")
