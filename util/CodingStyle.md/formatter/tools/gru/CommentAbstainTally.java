...
public final class CommentAbstainTally {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (final Map.Entry<String, int[]> entry : perLangCounts.entrySet()) {
            ...
            System.out.printf("%-10s %8d %8d %8d %9.1f%%%n", entry.getKey(), counts[0], counts[1], counts[2],
        ...
        System.out.printf("%-10s %8d %8d %8d %9.1f%%%n", "TOTAL", grandTotal[0], grandTotal[1], grandTotal[2],
